...
def login():
    ...
    try:
        ...
        print '\x1b[1;91m[\xe2\x98\x86] \x1b[1;92mLogin akun Pesbuk kamu ya \x1b[1;91m[\xe2\x98\x86]'
        ...
        try:
            ...
            print '\n\x1b[1;91m[!] Tidak ada koneksi bangsat'
            keluar()
...
def pilih():
    ...
    if zedd == '':
        print '\x1b[1;91m[!] Gunakan dengan benar tai!!!'
        pilih()
    else:
        if zedd == '1':
            informasi()
